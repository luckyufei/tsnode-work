...
module.exports = async function (options, callback) {
    ...
    var initServers = function (_ctx) {
        ...
        var startRulesServer = getFunction(execPlugin.pluginRulesServer ||
        ...
        var startTunnelServer = getFunction(execPlugin.pluginServer ||
            execPlugin.tunnelServer ||
            execPlugin.connectServer) || startServer;
            ...
            if (execAuth) {
                ...
                authServer.on('request', async function (req, res) {
                    ...
                    try {
                        ...
                        res.end(e && e.message && typeof e.message === 'string'
                            ? e.message
                            : 'Error');
                    }
                    htmlBody = null;
