...
exports.extend = function (newConf) {
    ...
    if (newConf) {
        ...
        var resolveShadowValues = function (obj) {
            if ((!obj.rules || typeof obj.rules === 'string') &&
                obj.values &&
        ...
        if (typeof newConf.mode === 'string') {
            ...
            mode.forEach(function (m) {
                ...
                else if (m === 'notAllowDisableRules' ||
                ...
                else if (m === 'disableMultipleOption' ||
                    m === 'disabledMultipleOption') {
                    config.disabledMultipleOption = true;
                }
                else if (m === 'disableRulesOptions' ||
                ...
                else if (m === 'notAllowDisablePlugins' ||
